    ...
    <>
      ...
      <div className="info_card" style={{ marginTop: 14 }}>
        ...
        <div className="kv">
          ...
          <div className="v">{contract.actData?.customer?.phone || "—"}</div>
          <div className="k">Email</div>
          <div className="v">{contract.actData?.customer?.email || "—"}</div>
        </div>
      </div>

      {/* Директор */}
      {(contract.directorName || contract.directorPosition) && (
        <div className="info_card" style={{ marginTop: 14 }}>
          <div className="info_title">Подписант</div>
          <div className="kv">
            <div className="k">Должность</div>
            <div className="v">{contract.directorPosition || "Директор"}</div>
            <div className="k">ФИО</div>
            <div className="v">{contract.directorName || "—"}</div>
          </div>
        </div>
      )}
