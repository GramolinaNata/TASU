...
export default function SentToAccountantPage() {
  ...
  // 🆕 ТЗ: перевести отработанную заявку в отложенные
  const handleDefer = async (id) => {
    ...
    try {
      ...
      console.error(e);
      alert("Ошибка при переносе в отложенные: " + e.message);
    }
  };

  // 🆕 ТЗ: аннулировать отработанную заявку
  const handleAnnul = async (id, number) => {
    ...
    try {
      ...
      console.error(e);
      alert("Ошибка при аннулировании: " + e.message);
    }
  };
