...
//           ranges: [{ maxWeight: 999999, extra: parseFloat(regionExtraValue(r)) || 0 }],
//         }));
...
//                     <th style={{ width: 110 }}>Доставка</th>
//                   </>
//                 ) : (
//                   <>
...
//                           <td>{Number(t.deliveryPrice) > 0 ? Number(t.deliveryPrice).toLocaleString() : '—'}</td>
//                         </>
//                       ) : (
//                         <>
//                           <td>
...
//                   <div className="field">
//                     <div className="label">За кг (сверх {form.category === 'private' ? 30 : 20} кг)</div>
...
//                     </div>
//                     {WEIGHT_RANGES.map(r => (
//                       <div key={r.key} style={{ display: 'grid', gridTemplateColumns: '140px 1fr', gap: 10, alignItems: 'center', marginBottom: 8 }}>
...
//                   <div className="label">
//                     🚚 Доставка (тг)
//                     <span style={{ marginLeft: 6, fontSize: '0.7rem', color: '#0050b3' }}>
//                       (одна фикс. сумма, прибавляется к тарифу один раз)
//                     </span>
//                   </div>
//                   <input
//                     type="number"
...
//                     <input
//                       type="number"
//                       value={regionExtraValue(region)}
//                       onChange={e => {
//                         const val = parseFloat(e.target.value) || 0;
//                         const next = [...form.regionalDeliveries];
//                         next[idx] = { region: next[idx].region, ranges: [{ maxWeight: 999999, extra: val }] };
//                         setForm({ ...form, regionalDeliveries: next });
//                       }}
//                       placeholder="2000"
//                     />
          ...
          <table className="table">
            <thead>
              ...
              {tab === 'legal' ? (
                  ...
                  <>
                    <th>{(tab === 'loaders' || tab === 'carriers') ? 'Ставка за кг' : 'Диапазоны весов'}</th>
                    <th style={{ width: 110 }}>Доставка</th>
                  </>
                )}
                <th style={{ width: 200, textAlign: "right" }}>Действия</th>
...
<div className="modal_content card animate_slide_up" style={{ width: 580, maxWidth: '95vw', padding: 32, maxHeight: '90vh', overflowY: 'auto' }}>            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
            ...
            <form onSubmit={handleSave}>
             ...
             {form.isPrivate && (
              ...
              {(form.category === 'loaders' || form.category === 'carriers') && (
                <div className="field" style={{ marginBottom: 16, padding: 12, background: '#eef2ff', borderRadius: 8, border: '1px dashed #a5b4fc' }}>
                  ...
                  <input
                    ...
                    placeholder={form.category === 'loaders' ? '10' : '65'}
                  />
                </div>
              )}
