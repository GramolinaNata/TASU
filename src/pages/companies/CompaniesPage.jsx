          ...
          <div className="form_grid" style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
             ...
             <div className="field">
              ...
              <div className="field">
                <div className="label">Налоговый режим</div>
                <select
                  value={form.taxMode}
                ...
                >
                  ...
                  <option value="simplified">Упрощёнка (СНР)</option>
                  <option value="our">ОУР (с НДС)</option>
                </select>
              </div>

              {form.taxMode === 'simplified' && (
                <>
                  <div className="field">
                    <div className="label">Ставка налога, %</div>
                    <input type="number" step="0.1" value={form.taxRate} onChange={(e) => setForm({ ...form, taxRate: e.target.value })} placeholder="3" />
                  ...
                  <div className="field">
                    <div className="label">Доп. сбор, % <span style={{ color: '#94a3b8', fontWeight: 400 }}>(напр. 1% за снятие)</span></div>
                    <input type="number" step="0.1" value={form.taxExtra} onChange={(e) => setForm({ ...form, taxExtra: e.target.value })} placeholder="1" />
                  </div>
                </>
              )}
