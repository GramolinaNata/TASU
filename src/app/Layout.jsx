              ...
              <nav className="sidebar_menu" aria-label="Меню" style={{ flex: 1 }}>
                ...
                {isPrivate && (
                  <>
                    ...
                    <NavLink to="/simple" className={({ isActive }) => (isActive ? "selected_menu" : "")} title="Мои заявки">
                      <span className="menu_icon">📋</span>
                      <span className="menu_text">Мои заявки</span>
                    </NavLink>
                    <NavLink to="/simple/new" className={({ isActive }) => (isActive ? "selected_menu" : "")} title="Создать заявку">
                      <span className="menu_icon">➕</span>
                      <span className="menu_text">Создать заявку</span>
                    </NavLink>
                    <NavLink to="/simple/batches" className={({ isActive }) => (isActive ? "selected_menu" : "")} title="Партии">
                      <span className="menu_icon">📦</span>
                      <span className="menu_text">Партии</span>
                ...
                {/* Меню для МЕНЕДЖЕРА и АДМИНА (НЕ для PRIVATE и НЕ для бухгалтера) */}
                {(!isAnyAccountant || isAdmin) && !isPrivate && (
                  <>
                    <NavLink to="/acts" className={({ isActive }) => (isActive ? "selected_menu" : "")} title="Заявки">
                      <span className="menu_icon">📄</span>
                      <span className="menu_text">Заявки</span>
